...
const CartCourse = ({ lector, price, status, title, id, image, course }) => {
	...
	return (
		<div
			className='flex flex-col w-[322px] bg-blur  rounded-lg p-3 max-h-[459px] hover:shadow1 duration-500 gap-2 cursor-pointer'
		...
		>
			...
			<div className='   '>
				<p className={`text-lg h-[35px] px-2 `}>{title}</p>
			</div>
