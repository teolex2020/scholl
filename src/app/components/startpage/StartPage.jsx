...
const StartPage = ({ title, name, descriptions, button, info }) => {
	return (
		<AnimatePresence>
			<motion.div className='container mx-auto elem bg-blur mb-10 py-5  mt-5    relative rounded-xl max-w-[1346px]  '>
				<div className='flex justify-around flex-col lg:flex-row items-center lg:gap-48 '>
					<motion.div
						...
						exit={{ scale: 0 }}
						className=' flex lg:flex-1 h-48 lg:h-[400px] w-96  relative justify-center '
					>
