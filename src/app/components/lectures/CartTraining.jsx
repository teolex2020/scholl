...
const CartCourse = ({ lector, price, status, title, id, image, course, active }) => {
	...
	return (
		<div
			className='flex flex-col w-[322px] bg-blur  rounded-lg p-3 h-[480px] hover:shadow1 duration-500 gap-2 cursor-pointer'
		...
		>
			...
			<div className='   '>
				<p className={`text-base h-[60px] px-2 `}>{title}</p>
			</div>
