...
import bannerImage from '../../../../public/assets/log.webp'
			...
			<div className='flex flex-col lg:flex-row h-full justify-around '>
				...
				<div className='flex flex-col justify-center items-start text-left px-5 sm:px-10 py-6 sm:py-10 lg:w-1/2 z-10 gap-5'>
					...
					<motion.h1
						...
						className='text-xl sm:text-5xl font-bold text-[#d8b150] max-w-xl leading-tight'
					...
					<motion.button
						...
						className='px-6 py-3 border border-[#d8b150] rounded-xl text-[#d8b150] hover:bg-[#d8b150] hover:text-black transition font-semibold hidden sm:block hover:shadow-lg'
					>
						Переглянути курси
					</motion.button>
				</div>
