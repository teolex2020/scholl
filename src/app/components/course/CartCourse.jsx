...
const CartCourse = ({ lector, price, status, title, id, image, course }) => {
	...
	return (
		<div
			className='flex flex-col w-[322px] bg-blur  rounded-lg p-3 max-h-[439px] hover:shadow1 duration-500 gap-2 cursor-pointer'
		...
		>
			...
			<div className='w-[300px] min-h-48 mx-auto  flex justify-center relative mt-1 '>
				<Image
					src={`/assets/${image}`}
			...
			<div className='   '>
				<p className={`text-[16px] h-[80px] px-2 `}>{title}</p>
			</div>
